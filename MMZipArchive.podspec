...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/z415073783/MMZipArchive.git"
  ...
  spec.source       = { :git => "git@github.com:z415073783/MMZipArchive.git", :tag => spec.version }
